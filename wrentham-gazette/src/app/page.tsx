...
export default function HomePage() {
  ...
  return (
    <>
      <BreakingNews
        headline="Select Board schedules special meeting on Route 1A development proposal — Jan. 8 at 7 PM"
        link="/articles/select-board-reviews-2026-budget-priorities"
      />
