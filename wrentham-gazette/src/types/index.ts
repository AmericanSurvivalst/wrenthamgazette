...
export const CATEGORIES: CategoryInfo[] = [
  { slug: 'town-government', name: 'Town Government', description: 'Select Board, Planning, Town Meeting, and more' },
  ...
  { slug: 'police-fire', name: 'Police & Fire', description: 'Public safety news and logs' },
  { slug: 'business', name: 'Business', description: 'Local business news and openings' },
